...
header_template = """<header class="site-header" role="banner">
...
for filepath in html_files:
    ...
    # Extract existing dropdown menu
    dropdown_match = re.search(r'(<div class="header-dropdown-menu" id="header-dropdown-menu".*?</div>)', content, re.DOTALL)
    if not dropdown_match:
        print(f"Could not find dropdown menu in {filepath}")
        continue
