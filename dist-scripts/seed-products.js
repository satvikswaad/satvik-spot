...
exports.CANONICAL_SEED_PRODUCTS = void 0;
exports.parseArgs = parseArgs;
exports.runProductSeed = runProductSeed;
const app_1 = require("firebase-admin/app");
const firestore_1 = require("firebase-admin/firestore");
exports.CANONICAL_SEED_PRODUCTS = [
    {
        id: 'prod_aam_achar',
        sku: 'SKU-AAM-001',
        ...
        cat: 'achar',
        emoji: '🥭',
        img: 'assets/aam-ka-achar.png',
        images: ['assets/aam-ka-achar.png'],
    ...
    },
    {
        ...
        cat: 'achar',
        emoji: '🥒',
        img: 'assets/karela-ka-achar.png',
        images: ['assets/karela-ka-achar.png'],
    ...
    },
    {
        ...
        cat: 'achar',
        emoji: '🍈',
        img: 'assets/amla-ka-achar.png',
        images: ['assets/amla-ka-achar.png'],
    ...
    },
    {
        ...
        cat: 'achar',
        emoji: '🥣',
        img: 'assets/amla-ki-chutney.png',
        images: ['assets/amla-ki-chutney.png'],
    ...
    },
    {
        ...
        cat: 'achar',
        emoji: '🌶️',
        img: 'assets/lal-mirch-ka-achar.png',
        images: ['assets/lal-mirch-ka-achar.png'],
    ...
    },
    {
        ...
        cat: 'achar',
        emoji: '🌶️',
        img: 'assets/hari-mirch-ka-achar.png',
        images: ['assets/hari-mirch-ka-achar.png'],
    ...
    },
    {
        ...
        cat: 'achar',
        emoji: '🍋',
        img: 'assets/nimbu-mirch-ka-achar.png',
        images: ['assets/nimbu-mirch-ka-achar.png'],
    ...
    },
    {
        ...
        cat: 'achar',
        emoji: '🧄',
        img: 'assets/amda-ka-achar.png',
        images: ['assets/amda-ka-achar.png'],
    ...
    },
    {
        ...
        cat: 'achar',
        emoji: '🥗',
        img: 'assets/kathal-ka-achar.png',
        images: ['assets/kathal-ka-achar.png'],
    ...
    },
    {
        ...
        cat: 'murabba',
        emoji: '🍈',
        img: 'assets/amla-murabba-sugar.png',
        images: ['assets/amla-murabba-sugar.png'],
    ...
    },
    {
        ...
        cat: 'murabba',
        emoji: '🍎',
        img: 'assets/amla-murabba-jaggery.png',
        images: ['assets/amla-murabba-jaggery.png'],
    ...
    },
    {
        ...
        cat: 'sweets',
        emoji: '🟡',
        img: 'assets/amla-laddu-jaggery.png',
        images: ['assets/amla-laddu-jaggery.png'],
    ...
    },
    {
        ...
        cat: 'sweets',
        emoji: '🟡',
        img: 'assets/amla-laddu-sugar.png',
        images: ['assets/amla-laddu-sugar.png'],
    ...
    },
    {
        ...
        cat: 'health',
        emoji: '🧃',
        img: 'assets/amla-juice.png',
        images: ['assets/amla-juice.png'],
    ...
    },
    {
        ...
        cat: 'health',
        emoji: '🍯',
        img: 'assets/chyawanprash.png',
        images: ['assets/chyawanprash.png'],
...
async function runProductSeed(options = {}) {
    ...
    for (const prod of exports.CANONICAL_SEED_PRODUCTS) {
    ...
    // 6. Validate Schema
    for (const p of exports.CANONICAL_SEED_PRODUCTS) {
        if (!p.id || !p.name || p.price <= 0 || p.mrp < p.price || p.stock < 0) {
            throw new Error(`Validation failed for product ID ${p.id}`);
        }
    }
    console.log(`✅ Validated ${exports.CANONICAL_SEED_PRODUCTS.length} canonical products. Zero duplicate SKUs found.`);
    if (dryRun) {
        console.log('ℹ️ Dry-run completed successfully. No changes written to database.');
        return { success: true, count: exports.CANONICAL_SEED_PRODUCTS.length, dryRun: true };
    }
    // 7. Initialize Admin SDK
    const apps = (0, app_1.getApps)();
    const app = apps.length ? apps[0] : (0, app_1.initializeApp)({ projectId: project });
    ...
    await batch.commit();
    console.log(`🎉 Successfully seeded ${exports.CANONICAL_SEED_PRODUCTS.length} products to Firestore '/products' collection in project '${project}'.`);
    return { success: true, count: exports.CANONICAL_SEED_PRODUCTS.length, dryRun: false };
}
